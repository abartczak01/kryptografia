...
def decrypt():
    ...
    # printable_key = "".join(['_' if item is None else item for item in key])
    # print(printable_key)
    decrypted_text = ""
...
# supertajny klucz powtarzalny niestety kryptografiaSzyfrowanieXOR
# w zadaniu pokazujacym mozliwosci uzyskania informacji ze zna xor